...
QT_MOC_LITERAL(3, 26, 5)
    ...
    "GLWidget\0layerSetChanged\0\0layer\0"
};
...
void GLWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->layerSetChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&GLWidget::layerSetChanged)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void GLWidget::layerSetChanged(int _t1)
{
